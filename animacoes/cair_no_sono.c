...
void cair_no_sono() // a função roda o a animação de dormir, quando o personagem dorme no meio do quarto
{
    ...
    napms(3000);
        ...
        mvwprintw(dormindu, olhosonoY-2,     olhosonoX, "Voce se exauriu ao maximo fazendo atividades apos a hora");
        wrefresh(dormindu);
        napms(3000);
        mvwprintw(dormindu, olhosonoY-1,     olhosonoX, "Voce sem nem percebe, no mesmo lugar que estava, dormiu...");
        wrefresh(dormindu);
        napms(3000);
}